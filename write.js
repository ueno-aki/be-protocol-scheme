() => {
  const ctx = {
    ...
    Vec3fopts: (value, buffer, offset) => {
      let x = value.x
      offset = ((value, buffer, offset) => {
        if (value != null) {
          offset = ctx.bool(1, buffer, offset)
          offset = (ctx.lf32)(value, buffer, offset)
        } else {
    ...
    ItemStackResponses: (value, buffer, offset) => {
      ...
      for (let i = 0; i < value.length; i++) {
        ...
        offset = (ctx.zigzag32)(request_id1, buffer, offset)
              ...
              for (let i = 0; i < value.length; i++) {
                ...
                offset = ((value, buffer, offset) => {
                  ...
                  for (let i = 0; i < value.length; i++) {
                    ...
                    offset = (ctx.zigzag32)(item_stack_id, buffer, offset)
    ...
    mcpe_packet: (value, buffer, offset) => {
      ...
      offset = ((value, buffer, offset) => {
        switch (name) {
          ...
          case "agent_animation": return (ctx.packet_agent_animation)(value, buffer, offset)
          case "refresh_entitlements": return (ctx.packet_refresh_entitlements)(value, buffer, offset)
          default: return (ctx.void)(value, buffer, offset)
        }
    ...
    packet_resource_packs_info: (value, buffer, offset) => {
      ...
      offset = ((value, buffer, offset) => {
        ...
        for (let i = 0; i < value.length; i++) {
          ...
          let url1 = value.url
          offset = (ctx.string)(url1, buffer, offset)
          return offset
        })(value[i], buffer, offset)
        }
        return offset
      })(resource_pack_links, buffer, offset)
      return offset
    },
    ...
    packet_start_game: (value, buffer, offset) => {
      ...
      offset = ((value, buffer, offset) => {
        return (ctx.zigzag32)({"not_editor":0,"project":1,"test_level":2}[value] || value, buffer, offset)
      })(editor_world_type, buffer, offset)
    ...
    packet_available_commands: (value, buffer, offset) => {
      ...
      offset = ((value, buffer, offset) => {
        ...
        return offset
      })(chained_subcommand_values, buffer, offset)
      ...
      offset = ((value, buffer, offset) => {
        ...
        for (let i = 0; i < value.length; i++) {
          ...
          offset = ((value, buffer, offset) => {
            ...
            for (let i = 0; i < value.length; i++) {
              ...
              offset = (ctx.lu16)(index, buffer, offset)
              let value2 = value.value
              offset = (ctx.lu16)(value2, buffer, offset)
              return offset
            })(value[i], buffer, offset)
            }
            return offset
        ...
        return offset
      })(chained_subcommands, buffer, offset)
      ...
      offset = ((value, buffer, offset) => {
        ...
        for (let i = 0; i < value.length; i++) {
          ...
          offset = ((value, buffer, offset) => {
            offset = (ctx.varint)(value.length, buffer, offset)
            for (let i = 0; i < value.length; i++) {
              offset = (ctx.lu16)(value[i], buffer, offset)
            }
            return offset
          })(chained_subcommand_offsets, buffer, offset)
          ...
          offset = ((value, buffer, offset) => {
            ...
            for (let i = 0; i < value.length; i++) {
              ...
              offset = (ctx.bool)(chaining, buffer, offset)
              ...
              offset = ((value, buffer, offset) => {
                ...
                for (let i = 0; i < value.length; i++) {
                  ...
                  offset = ((value, buffer, offset) => {
                    return (ctx.lu16)({"valid":16,"enum":48,"suffixed":256,"soft_enum":1040}[value] || value, buffer, offset)
    ...
    packet_update_soft_enum: (value, buffer, offset) => {
      let enum_type = value.enum_type
      offset = (ctx.string)(enum_type, buffer, offset)
      let options = value.options
      offset = ((value, buffer, offset) => {
        offset = (ctx.varint)(value.length, buffer, offset)
        for (let i = 0; i < value.length; i++) {
      ...
      let action_type = value.action_type
      offset = ((value, buffer, offset) => {
        return (ctx.u8)({"add":0,"remove":1,"update":2}[value] || value, buffer, offset)
      })(action_type, buffer, offset)
      return offset
    },
      ...
      offset = ((value, buffer, offset) => {
        switch (has_external_link_settings) {
          case true: return ((value, buffer, offset) => {
            ...
            offset = (ctx.string)(display_name1, buffer, offset)
            return offset
          })(value, buffer, offset)
          default: return (ctx.void)(value, buffer, offset)
        }
    ...
    packet_completed_using_item: (value, buffer, offset) => {
      ...
      offset = ((value, buffer, offset) => {
        return (ctx.li32)({"equip_armor":0,"eat":1,"attack":2,"consume":3,"throw":4,"shoot":5,"place":6,"fill_bottle":7,"fill_bucket":8,"pour_bucket":9,"use_tool":10,"interact":11,"retrieved":12,"dyed":13,"traded":14,"brushing_completed":15}[value] || value, buffer, offset)
        ...
        switch (input_data.block_action) {
          case true: return ((value, buffer, offset) => {
            ...
            for (let i = 0; i < value.length; i++) {
              ...
              offset = ((value, buffer, offset) => {
                switch (action1) {
                  case "start_break": return (ctx.vec3i)(value, buffer, offset)
                  case "abort_break": return (ctx.vec3i)(value, buffer, offset)
                  case "crack_break": return (ctx.vec3i)(value, buffer, offset)
                  case "predict_break": return (ctx.vec3i)(value, buffer, offset)
                  case "continue_break": return (ctx.vec3i)(value, buffer, offset)
                  default: return (ctx.void)(value, buffer, offset)
                }
    ...
    packet_camera_presets: (value, buffer, offset) => {
      ...
      offset = (ctx.string)(parent, buffer, offset)
      let position = value.position
      offset = (ctx.Vec3fopts)(position, buffer, offset)
      let rotation = value.rotation
      offset = (ctx.Vec2fopts)(rotation, buffer, offset)
      let audio_listener = value.audio_listener
      offset = ((value, buffer, offset) => {
        if (value != null) {
          offset = ctx.bool(1, buffer, offset)
          offset = (ctx.u8)(value, buffer, offset)
        } else {
          offset = ctx.bool(0, buffer, offset)
        }
        return offset
      })(audio_listener, buffer, offset)
      let player_effects = value.player_effects
      offset = ((value, buffer, offset) => {
        if (value != null) {
          offset = ctx.bool(1, buffer, offset)
          offset = (ctx.bool)(value, buffer, offset)
        } else {
          offset = ctx.bool(0, buffer, offset)
        }
        return offset
      })(player_effects, buffer, offset)
      return offset
    },
    ...
    packet_camera_instruction: (value, buffer, offset) => {
      ...
      offset = ((value, buffer, offset) => {
        if (value != null) {
          ...
          offset = (ctx.li32)(runtime_id1, buffer, offset)
          ...
          offset = ((value, buffer, offset) => {
            ...
            return offset
          })(ease_data, buffer, offset)
          let position1 = value.position
          offset = ((value, buffer, offset) => {
            if (value != null) {
              offset = ctx.bool(1, buffer, offset)
              offset = (ctx.vec3f)(value, buffer, offset)
            } else {
              offset = ctx.bool(0, buffer, offset)
            }
            return offset
          ...
          offset = ((value, buffer, offset) => {
            if (value != null) {
              offset = ctx.bool(1, buffer, offset)
              offset = (ctx.vec2f)(value, buffer, offset)
            } else {
              offset = ctx.bool(0, buffer, offset)
            }
            return offset
          })(rotation1, buffer, offset)
      ...
      offset = ((value, buffer, offset) => {
        if (value != null) {
          ...
          offset = (ctx.lf32)(fade_in_duration, buffer, offset)
          let wait_duration = value.wait_duration
          offset = (ctx.lf32)(wait_duration, buffer, offset)
          let fade_out_duration = value.fade_out_duration
          offset = (ctx.lf32)(fade_out_duration, buffer, offset)
          let color_rgb = value.color_rgb
          offset = (ctx.vec3f)(color_rgb, buffer, offset)
          return offset
        })(value, buffer, offset)
        } else {
          offset = ctx.bool(0, buffer, offset)
    ...
    packet_agent_animation: (value, buffer, offset) => {
      let animation = value.animation
      offset = ((value, buffer, offset) => {
        return (ctx.u8)({"arm_swing":0,"shrug":1}[value] || value, buffer, offset)
      })(animation, buffer, offset)
      let entity_runtime_id = value.entity_runtime_id
      offset = (ctx.varint64)(entity_runtime_id, buffer, offset)
      return offset
    },
    packet_refresh_entitlements: (value, buffer, offset) => {
      return offset
    },
